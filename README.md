...
Include `docs/raster/wfer_overlay.png` (~6 MB) in the commit so GitHub Pages can serve it.
...
| `docs/raster/` | WFER PNG overlay + bounds metadata |
| `inputs/wfer.tif` | Source WFER raster |
| `scripts/prepare_raster.py` | Build web overlay PNG |
